...
// Source: github.com/gabriel/gabrielyea/go-bank/repo (interfaces: Store)
...
import (
	...
	repo "github.com/gabriel/gabrielyea/go-bank/repo"
...
func (m *MockStore) GetEntries(arg0 context.Context, arg1 repo.GetEntriesParams) ([]repo.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTransfer(arg0 context.Context, arg1 repo.ListTransferParams) ([]repo.Transfer, error) {
	m.ctrl.T.Helper()
